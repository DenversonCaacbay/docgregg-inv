        ...
        <div class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col" >
                    ...
                    <h3>Step 2: Apply</h3>
                    <p>The second step is to apply through our system and complete the entire form provided below.
            ...
            <div class="row text2">
                ...
                <div class="col">
                    <div class="card bg-primary card5">
                        <div class="card-header">
                            <h6> Need for these Documents<br><br> <i class="fas fa-file fa-2x"></i>  </h6>
                        </div>
                        <div class="card-body">
                            <ul style="text-align: left; font-size: 16px;">
                                <p class="card-text">
