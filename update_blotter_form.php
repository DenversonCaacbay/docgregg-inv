                ...
                <div class="card-header bg-primary text-white"> Update Peace and Order Data</div>
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data"> 
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="custom-file form-group">
                                        <input type="file" onchange="readURL(this);" value="<?= $view['blot_photo']?>" class="custom-file-input" id="customFile" name="blot_photo">
                            ...
                            <div class="row">
                                <div class="col">
                                    <img id="blah" src="<?= $view['blot_photo']?>" alt="your image" style="margin-left: 20%;" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" id="report" name="narrative"><?= $view['narrative']?></textarea>
                                    </div>
                                </div>
                            </div>
