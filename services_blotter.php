                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back bg-info" style="font-size: 15px;">
                                <br>
                                Step 1: Fill out the entire form in our system.
                                <br><br>
                                Step 2: Verify all the information provided in our system, which we'll use to solve your case as quickly as possible.
                                <br><br>
                                Step 3: Approve your complaint so that we can schedule an appointment to reach an agreement on both sides.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back  bg-info">
                                <br>
                                <h5>The entry in the barangay blotter simply states that the private complainant was embraced ("niyakap") by the accused. This could be due to inaccurate reporting or to the victim's incomplete narration of events, whether intentional or not.</h5> 
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back  bg-info">
                                <br>
                                <h5>A written record of arrests and other incidents maintained by the barangay. It's the report kept by the barangay when a suspect is booked, involving the written recording of facts about the person's arrest and the charges against them.</h5> 
                            </div>
                        </div>
                    </div>
                </div>
