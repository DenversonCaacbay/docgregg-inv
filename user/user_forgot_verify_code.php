...
if (isset($_POST['verify'])) {
    ...
    $query = "SELECT * FROM tbl_user WHERE email='$email' AND verification_code='$verification_code' AND verified=1";
    ...
    if ($result->num_rows > 0) {
        ...
        if ($conn->query($updateQuery) === TRUE) {
            ...
            header("Location: user_change_password.php?email=" . urlencode($_POST['email']) . "&verification_code=" . urlencode($verification_code));
