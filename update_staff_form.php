                    ...
                    <form method="post">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="lname" placeholder="Enter Last Name" value="<?= $staff['lname'];?>" required>
                            </div>
                            <div class="col">
                                <label class="form-group" >First Name: </label>
                                <input type="text" class="form-control" name="fname" placeholder="Enter First Name" value="<?= $staff['fname'];?>" required>
                            </div>
                            <div class="col">
                                <label class="form-group"> Middle Name: </label>
                                <input type="text" class="form-control" name="mi" maxlength="1" placeholder="Enter Middle Name" value="<?= $staff['mi'];?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-top: 1.1em;">
                            <div class="col">
                                ...
                                <input type="email" class="form-control" name="email"  placeholder="Enter Email" value="<?= $staff['email'];?>" required>
                            </div>
