 ...
 <body class="skin-black" >
     ...
     ?>         
                ...
                <div class="col-xs-12 col-sm-5 col-md-8" style="background: white;  ">`
                    ...
                    <image src="../BarangaySystem/icons/santaritalogo.png"  ALIGN="left" style="width:150px;height:120px;"></image>
                    <image src="../BarangaySystem/icons/santaritalogo.png"  ALIGN="right" style="width:150px;height:120px;"></image> 
                        Republic of the Philippines<br>
                        Municipality of Olongapo<br>
                        Province of Zambales<br>
                        BARANGAY SANTA RITA<br>
                        Tel. +047 223-7768<br></b>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-12" style="padding-left: 96px;padding-right: 96px;" >
                        ...
                        <label style="font-size:17px;margin-left:70%;"><b>ROWENA CEREZO</b>  </label><br> 
