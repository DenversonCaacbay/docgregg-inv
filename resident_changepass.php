                                        ...
                                        <div class="col">
                                            <form method="post">
                                                ...
                                                <div class="input-container">
                                                    ...
                                                    <input class="input-field" type="password" id="password-field" name="oldpassword" placeholder="Enter Current Password" require>
                                                ...
                                                <div class="input-container">
                                                    ...
                                                    <input class="input-field" id="password1" type="password" name="newpassword" placeholder="Enter New Password" require>
                                                </div>
                                                ...
                                                <div class="input-container">
                                                    ...
                                                    <input class="input-field" id="confirm_password" type="password" name="confirm_password" placeholder="Enter Verify Password" require>
                                                </div>
