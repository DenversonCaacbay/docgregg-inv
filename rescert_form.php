...
<style>
 ...
 <head>
    <meta charset="UTF-8">
    <title>Barangay Santa Rita Information System</title>
       ...
       <div class="col-xs-12 col-sm-6 col-md-8"  >
            <div style=" background: black;" >
                <div class="col-xs-4 col-sm-6 col-md-3" style="background: white; margin-right:10px; border: 2px solid black;">
                    <center><image src="../BarangaySystem/icons/santaritalogo.png" style="width:90%;height:164px;"/></center>
                    <div style="margin-top:20px; text-align: center; word-wrap: break-word;">
                        
                                    <p style="margin-top: 2em;">
                                    <b>Hon. Rowena V. Cerezo</b><br>
                                    <span style="font-size:12px;">PUNONG BARANGAY</span>
                                    </p><br>
                                    <p>
                                    Hon. Ronald B. Guevarra<br>
                                    <span style="font-size:12px;">Barangay Kagawad</span>
                                    </p><br>
                                    
                                    <p>
                                    Hon. Raquel Y. Atienza<br>
                                    <span style="font-size:12px;">Barangay Kagawad</span>
                                    </p><br>
                                    
                                    <p>
                                    Hon. Ely R. Pamintuan<br>
                                    <span style="font-size:12px;">Barangay Kagawad</span>
                                    </p><br>
                                    <p>
                                    Hon. Dolores M. Valdez<br>
                                    <span style="font-size:12px;">Barangay Kagawad</span>
                                    </p><br>
                                   
                                    <p>
                                    Hon. Joelito T. Cruz, Jr.<br>
                                    <span style="font-size:12px;">Barangay Kagawad</span>
                                    </p><br>
                                   
                                    <p>
                                    Hon. Antonio R. Calixtro<br>
                                    <span style="font-size:12px;">Barangay Kagawad</span>
                                    </p><br>
                                  
                                    <p>
                                    Hon. Rodman A. Barroga<br>
                                    <span style="font-size:12px;">Barangay Kagawad</span>
                                    </p>
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">`
                    <div class="pull-center" style="font-size: 16px; text-align:center;"><b>
                        ...
                        Municipality of Olongapo<br>
                        Province of Zambales<br>
                        BARANGAY SANTA RITA<br>
                        Tel. +047 223-7768<br><br></b>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <p style="text-indent:40px;text-align: justify;">Issued this <?= $resident['date'];?> Olongapo City. </p>
                        ...
                        <label style="font-size:18px;">____________</label>    <label style="font-size:18px;margin-left:4em;">ROWENA V. CEREZO</label><br> 
