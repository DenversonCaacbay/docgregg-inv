	...
	<table class="table table-hover text-center table-bordered table-responsive" >
		...
		<tbody>
			...
			<?php
				...
				or `brgy` LIKE '%$keyword%' or `municipal` LIKE '%$keyword%' or `contact` LIKE '%$keyword%' ");
				$stmnt->execute();
            ...
            <td>    
                ...
                <td>
                    <!-- checks photo exist -->
                    <?php if (is_null($view['blot_photo'])): ?>
                        <span>No Image Available</span>
                    <?php else: ?>
                        <a class="btn btn-success" target="_blank" href="<?php echo $view['blot_photo']; ?>">View</a>
                    <?php endif; ?>
                </td>
                <td> <?= $view['contact'];?> </td>
