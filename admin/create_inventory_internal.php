<?php
   ...
   $bmis->validate_admin();
   $staffbmis->create_inventory_internal();
                        ...
                        <div class="container">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                 ...
                                 <button class="btn btn-primary w-100" style="font-size: 18px; border-radius:5px;" type="submit" name="create_inventory_internal"> Create </button>
                            </div>
                        </div>
                        </div>
