<?php
    ...
    $view = $staffbmis->view_services_laboratory($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_services_laboratory(); // get the total number of records

// Calculate the total number of pages
    $totalPages = ceil($totalRecords / $recordsPerPage);
    function getServiceLaboratory($serviceAvailed) {
                        ...
                        <?php if(is_array($view)) {?>
                            <?php foreach($view as $view) {?>
                                <tr>
                                    ...
                                    <td><?= getServiceLaboratory($view['service_availed']); ?></td>
