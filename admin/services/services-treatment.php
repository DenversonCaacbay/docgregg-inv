<?php
    ...
    $view = $staffbmis->view_services_treatment($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_services_treatment(); // get the total number of records

// Calculate the total number of pages
    $totalPages = ceil($totalRecords / $recordsPerPage);
    function getServiceTreatment($serviceAvailed) {
                    ...
                    <?php if (is_array($view) && count($view) > 0) { ?>
                            <?php foreach($view as $view) {?>
                                <tr>
                                    ...
                                    <td><?= getServiceTreatment($view['service_availed']); ?></td>
