<?php
    ...
    $view = $staffbmis->view_services_consultation($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_services_consultation(); // get the total number of records

// Calculate the total number of pages
    $totalPages = ceil($totalRecords / $recordsPerPage);
    
    function getServiceConsultation($serviceAvailed) {
                    ...
                    <?php if (is_array($view) && count($view) > 0) { ?>
                            <?php foreach($view as $view) {?>
                                <tr>
                                    ...
                                    <td><?= getServiceConsultation($view['service_availed']); ?></td>
