<?php
    ...
    $view = $staffbmis->view_services_vaccination($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_services_vaccination(); // get the total number of records

// Calculate the total number of pages
    $totalPages = ceil($totalRecords / $recordsPerPage);

    function getServiceVaccination($serviceAvailed) {
                    ...
                    <?php if (is_array($view) && count($view) > 0) { ?>
                            <?php foreach($view as $view) {?>
                                <tr>
                                    ...
                                    <td><?= getServiceVaccination($view['service_availed']); ?></td>
...
<script src="services_search.js"></script>
