<?php
    ...
    $view = $staffbmis->view_services_surgery($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_services_surgery(); // get the total number of records

// Calculate the total number of pages
    $totalPages = ceil($totalRecords / $recordsPerPage);

    function getServiceSurgery($serviceAvailed) {
