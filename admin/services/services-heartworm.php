<?php
    ...
    $view = $staffbmis->view_services_heartworm($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_services_heartworm(); // get the total number of records

// Calculate the total number of pages
    $totalPages = ceil($totalRecords / $recordsPerPage);
    function getServiceHeartworm($serviceAvailed) {
        $services = explode(', ', $serviceAvailed);
        foreach ($services as $service) {
            if ($service == 'Heartworm') {
                return $service;
            }
        }
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="categorySelect" class="form-select" aria-label="Default select example">
                    ...
                    <option selected>HeartWorm</option>
                    ...
                    <?php if (is_array($view) && count($view) > 0) { ?>
                            <?php foreach($view as $view) {?>
                                <tr>
                                    ...
                                    <td><?= getServiceHeartworm($view['service_availed']); ?></td>
