<?php
    ...
    $view = $staffbmis->view_services_grooming($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_services_grooming(); // get the total number of records

// Calculate the total number of pages
    $totalPages = ceil($totalRecords / $recordsPerPage);
    function getServiceGrooming($serviceAvailed) {
                        ...
                        <?php if(is_array($view)) {?>
                            <?php foreach($view as $view) {?>
                                <tr>
                                    ...
                                    <td><?= getServiceGrooming($view['service_availed']); ?></td>
