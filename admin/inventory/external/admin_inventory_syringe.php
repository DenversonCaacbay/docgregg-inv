<?php
    ...
    $view = $staffbmis->view_inventory_external_syringe($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_inventory_syringe(); // get the total number of records
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="categorySelect" class="form-select" aria-label="Default select example">
                    ...
                    <option selected>Syringe</option>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Syringe Picture</h1>
