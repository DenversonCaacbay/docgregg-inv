<?php
    ...
    $view = $staffbmis->view_inventory_external_vaccine($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_inventory_vaccine(); // get the total number of records
...
<div class="container-fluid  page-container">
    ...
    <div class="row">
        <div class="col-md-6"><h4 class="">External Inventory</h4></div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="categorySelect" class="form-select" aria-label="Default select example">
                    ...
                    <option selected>Vaccine</option>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="openModal('../../<?= $view['picture'] ?>')">
                                            <img src="../../<?= $view['picture'] ?>"alt="Modal Image" width="50px" height="50px">
                                        </a>
                                        <?php endif; ?>
                                    </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Vaccine Picture</h1>
    ...
    $(document).ready(function () {
        $('#categorySelect').on('change', function () {
            ...
            if (selectedValue !== 'all') {
                ...
                window.location.href = '../../admin_inventory_external.php';
            }
        });
    });
</script> 
