<?php
    ...
    $view = $staffbmis->view_inventory_external_dogfood($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_inventory_dogfood(); // get the total number of records
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="categorySelect" class="form-select" aria-label="Default select example">
                    ...
                    <option selected>Dog Food</option>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Dog Food Picture</h1>
