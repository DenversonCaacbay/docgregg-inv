<?php
    ...
    $view = $staffbmis->view_inventory_both_vaccine($page, $recordsPerPage);
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6"><h1 class="">Both Internal / External</h1></div>
    ...
    $(document).ready(function () {
        $('#categorySelect').on('change', function () {
            ...
            if (selectedValue !== 'all') {
                ...
                window.location.href = '../../admin_inventory_both.php';
            }
        });
    });
</script> 
