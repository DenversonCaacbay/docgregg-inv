<?php
    ...
    $view = $staffbmis->view_inventory_internal_vaccine($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_inventory_internal_vaccine(); // get the total number of records
    ...
    $(document).ready(function () {
        $('#categorySelect').on('change', function () {
            ...
            if (selectedValue !== 'all') {
                ...
                window.location.href = '../../admin_inventory_internal.php';
            }
        });
    });
</script> 
