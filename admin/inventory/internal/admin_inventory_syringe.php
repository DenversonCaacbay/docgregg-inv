<?php
    ...
    $view = $staffbmis->view_inventory_internal_syringe($page, $recordsPerPage);
    $totalRecords = $staffbmis->count_inventory_internal_syringe(); // get the total number of records
