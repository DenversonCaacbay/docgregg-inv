<?php
    ...
    $view = $staffbmis->view_inventory_both($page, $recordsPerPage);
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="d-flex align-items-center">
                ...
                <h1 class="ms-2 mt-2">Both Internal / External</h1>
            </div>
    ...
    $(document).ready(function () {
        $('#categorySelect').on('change', function () {
            ...
            if (selectedValue !== 'all') {
                window.location.href = 'inventory/both/admin_inventory_' + selectedValue + '.php';
            }
        });
    });
</script> 
