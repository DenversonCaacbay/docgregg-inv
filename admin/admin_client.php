                        ...
                        <?php if(is_array($view)) {?>
                            <?php foreach($view as $view) {?>
                                ...
                                <td>
                                    ...
                                    <td>    
                                        <form action="" method="post">
                                            <a href="admin_client_info.php" style="width: 100px;padding:5px; font-size: 15px; border-radius:5px; margin-bottom: 2px;" class="btn btn-success"> View Record </a>
                                            <a href="admin_user_pet.php?id_user=<?= $view['id_admin'];?>" style="width: 100px;padding:5px; font-size: 15px; border-radius:5px; margin-bottom: 2px;" class="btn btn-success"> View Pets </a>
